<?php 
 ...
 ?>
		...
		<canvas id="canvas"></canvas>
			...
			<table>
					<td><input type="checkbox" id="cbox1" onclick="selectOnlyThis(this.id)">Filter 1</option></td>
					<td><input type="checkbox" id="cbox2" onclick="selectOnlyThis(this.id)">Filter 2</option></td>
					<td><input type="checkbox" id="cbox3" onclick="selectOnlyThis(this.id)">Filter 3</option></td>
				</form>
				</select>
